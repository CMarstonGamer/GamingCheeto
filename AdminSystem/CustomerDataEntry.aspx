...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtCustomerPassword" runat="server" style="z-index: 1; left: 143px; top: 147px; position: absolute" height="25px" width="168px" TextMode="Password"></asp:TextBox>
