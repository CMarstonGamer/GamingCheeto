...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 114px; top: 514px; position: absolute" Text="Delete" OnClick="btnDelete_Click" />
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 15px; top: 564px; position: absolute"></asp:Label>
    </form>
</body>
</html>
