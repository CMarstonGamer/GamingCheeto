...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnClearPrice" OnClick="btnClearPrice_Click" runat="server" style="z-index: 1; left: 715px; top: 250px; position: absolute" Text="Clear" />
        <asp:Button ID="btnClearStockQ" runat="server" style="z-index: 1; left: 715px; top: 435px; position: absolute" Text="Clear" />
        <asp:Button ID="btnApplyDate" runat="server" style="z-index: 1; left: 515px; top: 554px; position: absolute" Text="Apply" />
        <asp:Button ID="btnClearDate" runat="server" style="z-index: 1; left: 711px; top: 553px; position: absolute" Text="Clear" />
        ...
        <asp:Button ID="btnApplyInStock" runat="server" style="z-index: 1; left: 690px; top: 315px; position: absolute" Text="Apply" />
        <asp:Button ID="btnClearInStock" runat="server" style="z-index: 1; left: 790px; top: 315px; position: absolute" Text="Clear" />
        ...
        <asp:Button ID="btnApplyStockQ" runat="server" style="z-index: 1; left: 515px; top: 435px; position: absolute" Text="Apply" />
