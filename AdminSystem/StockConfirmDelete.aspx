...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnYes" OnClick="btnYes_Click" runat="server" style="z-index: 1; left: 84px; top: 118px; position: absolute" Text="Yes" />
        <asp:Button ID="btnNo" OnClick="btnNo_Click" runat="server" style="z-index: 1; left: 235px; position: absolute; top: 116px" Text="No" />
